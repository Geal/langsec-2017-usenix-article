...
the full software.
We describe how to leverage Rust's safety features and close integration with C,
the strength of the [nom][nom] parser combinators library,along with a
thorough [methodology][parsers17] to make existing software much more secure
by rewriting critical parts.
